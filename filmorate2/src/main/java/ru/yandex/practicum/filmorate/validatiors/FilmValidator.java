package ru.yandex.practicum.filmorate.validatiors;
...
public class FilmValidator {
    ...
    private static final Instant FIRST_MOVIE_RELEASE = Instant.from(LocalDate.of(1895, 12, 28));
    private static final Logger log = LoggerFactory.getLogger(FilmValidator.class);

    public static void validate(Film film, Map<Long, Film> films, HttpMethod method) throws ValidationException {
        validateName(film);
